...
import { ChangeDetectionStrategy, Component, Inject, Input, OnInit, PLATFORM_ID, viewChild, viewChildren } from '@angular/core';
...
@Component({
  ...
  styleUrl: './mapa-zonas.component.css',
...
`);
      imgMarker.className = 'img-marker'
